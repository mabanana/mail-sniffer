...
export const handleRequest: HandleRequest = async function (
  ...
  var storedTokenResponse = await kvGet(userId);
  ...
  } else if (tokentAPIResponseJSON["refresh_token"] === undefined) {
    console.log(
      "Cannot log you in. Please unlink your google account from mail-sniffer and log in again later."
    );
    return {
      status: 400,
      body: "Cannot log you in. Please unlink your google account from mail-sniffer and log in again later.",
    };
  }
